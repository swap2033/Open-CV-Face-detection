# -*- coding: utf-8 -*-
"""
Created on Sun Feb 18 00:30:32 2024
...
cv2.imwrite('output/test3.jpg', faces_detected_img)
...
cv2.imwrite('output/test4.jpg', faces_detected_img)
...
cv2.imwrite('output/test2.jpg', faces_detected_img)
